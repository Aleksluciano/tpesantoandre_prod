...
router.get("/:id", function(req, res, next) {
  ...
  User.find({}, function(err, users) {
    ...
    let usersfilters = users.filter(f => {
      ...
      /*    if (f.email !=  'super@super.com' && 
            f.email !=  'tpe.santoandre.sp61@gmail.com' &&
            f.email !=  'tpe.santoandre.sp76@gmail.com' &&
            f.email !=  'tpe.santoandre.sp112@gmail.com' &&
            f.email  !=  'tpe.santoandre.supcircuito@gmail.com' &&
            f.email  !=  'tpe.santoandre.logistica@gmail.com' )return true; */
    });
